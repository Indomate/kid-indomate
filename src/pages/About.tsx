...
export const About: React.FC = () => {
  return (
    ...
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-200 to-blue-200 text-white py-16 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 -right-6 bg-gradient-to-r from-pink-300 to-purple-300 rounded-2xl p-6 shadow-lg border-2 border-white"
            >
